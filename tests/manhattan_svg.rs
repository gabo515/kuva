...
fn test_manhattan_sequential() {
    let mp = ManhattanPlot::new().with_data(make_gwas_seq_data());
...
fn test_manhattan_bp_hg19() {
    let mp = ManhattanPlot::new().with_data_bp(make_gwas_bp_data(), GenomeBuild::Hg19);
...
fn test_manhattan_bp_t2t() {
    let mp = ManhattanPlot::new().with_data_bp(make_gwas_bp_data(), GenomeBuild::T2T);
